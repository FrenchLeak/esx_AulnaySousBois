Locales['fr'] = {
  ...
  ['AulnaySousBois_wear'] = 'tenue AulnaySousBois',
  ...
  ['AulnaySousBois_stock'] = 'AulnaySousBois Stock',

  -- Misc

  ['remove_object'] = 'appuyez sur ~INPUT_CONTEXT~ pour enlever l\'objet',

  ['map_blip'] = 'Quartier de AulnaySousBois',
  ...
  ['alert_police'] = 'alerte AulnaySousBois',
